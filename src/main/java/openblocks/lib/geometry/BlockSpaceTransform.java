...
// why in the FUCK are we doing asm
public abstract class BlockSpaceTransform {
    ...
    public AABB mapWorldToBlock(Orientation orientation, AABB aabb) {
    ...
    public AABB mapBlockToWorld(Orientation orientation, AABB aabb) {
